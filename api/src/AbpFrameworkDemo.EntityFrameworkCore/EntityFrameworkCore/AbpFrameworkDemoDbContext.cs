...
public class AbpFrameworkDemoDbContext :
    AbpDbContext<AbpFrameworkDemoDbContext>,
    IIdentityDbContext,
    ITenantManagementDbContext
{
    ...
    public AbpFrameworkDemoDbContext(DbContextOptions<AbpFrameworkDemoDbContext> options)
        : base(options)
    {
