...
{
    [DbContext(typeof(AbpFrameworkDemoDbContext))]
    [Migration("20231231174124_mig3_added_authorid_to_book")]
    partial class mig3_added_authorid_to_book
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AbpFrameworkDemo.Domain.Authors.Author", b =>
                {
                    b.Property<Guid>("Id")
            ...
            modelBuilder.Entity("AbpFrameworkDemo.Domain.Books.Book", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("AbpFrameworkDemo.Domain.Books.Book", b =>
                {
                    b.HasOne("AbpFrameworkDemo.Domain.Authors.Author", null)
                        .WithMany()
