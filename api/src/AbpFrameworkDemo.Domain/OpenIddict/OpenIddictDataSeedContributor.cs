...
namespace AbpFrameworkDemo.Domain.OpenIddict;
...
public class OpenIddictDataSeedContributor : IDataSeedContributor, ITransientDependency
{
    ...
    {
        if (await _openIddictScopeRepository.FindByNameAsync("AbpFrameworkDemo") == null)
        {
            await _scopeManager.CreateAsync(new OpenIddictScopeDescriptor {
                Name = "AbpFrameworkDemo", DisplayName = "AbpFrameworkDemo API", Resources = { "AbpFrameworkDemo" }
            });
        }
    }
    ...
    private async Task CreateApplicationsAsync()
    {
        ...
        var consoleAndAngularClientId = configurationSection["AbpFrameworkDemo_App:ClientId"];
        if (!consoleAndAngularClientId.IsNullOrWhiteSpace())
        {
            var consoleAndAngularClientRootUrl = configurationSection["AbpFrameworkDemo_App:RootUrl"]?.TrimEnd('/');
