...
namespace AbpFrameworkDemo.Application.Tests.Authors;

public abstract class AuthorAppService_Tests<TStartupModule> : AbpFrameworkDemoApplicationTestBase<TStartupModule>
